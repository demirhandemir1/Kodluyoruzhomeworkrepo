...
const countries = ["All", "Korea", "Japan", "China"]; // menu dizisi içindeki objelerin categorilerine bakarak bir dizi oluşturdum. Bu kadar kısa bir dizide kullanılabilir ama uzun dizilerde mümkün değil.
console.log("Kendi dizim: ", countries)
