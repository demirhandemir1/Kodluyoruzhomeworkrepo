...
function countrySet(data) {
  let duplicatedCounties = data.reduce((country1,country2) => country1.includes(country2) ? country1 : [...country1, country2], [])
  duplicatedCounties.unshift("All")
  console.log("Reduce dizi: ", duplicatedCounties)
  return duplicatedCounties
}
...
function showCountryButtons() {
  let newButton = "";
  countrySet(countries).forEach( buttonItem => {
    newButton +=
    `
